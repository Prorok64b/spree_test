...
ActiveRecord::Schema.define(version: 20180903201858) do
  ...
  create_table "attachments", force: :cascade do |t|
    ...
    t.string "file_csv_file_name"
    t.string "file_csv_content_type"
    t.integer "file_csv_file_size"
    t.datetime "file_csv_updated_at"
  end

  create_table "file_csvs", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
